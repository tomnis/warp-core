...
class SuccessfulInvokationAdapter(override val tags: Seq[Tag] = Nil) extends Adapter[String]("com.wday.warp.adap.spec", tags) {
...
class FailureInvokationAdapter(override val tags: Seq[Tag] = Nil) extends Adapter[String]("com.wday.warp.adap.spec", tags) {
  /** @return a [[scala.util.Success]] containing a [[TrialResult]], or a wrapped exception. */
  override def invoke(): Try[TrialResult[String]] = {
